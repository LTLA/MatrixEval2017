...
Iterating across the original data is difficult for sparse matrices (due to lack of memory locality) and impractical for file-based representations.
...
This indicates that, in practice, \beachmat{}'s computational overhead can be ignored.
