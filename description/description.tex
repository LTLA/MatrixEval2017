...
Each large matrix is stored as a dataset in a HDF5 file on disk, while in memory, it is represented in R by a \code{HDF5Matrix} object from the \textit{HDF5Array} package.
