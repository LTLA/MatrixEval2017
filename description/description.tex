...
\begin{itemize}
    ...
    \item Sparse matrices in compressed sparse column-orientated format (Additional Note~\suppsecsparse{}, Supplementary Figure~\suppfigsparseschem{}), 
        ...
        Indeed, for low-density sparse matrices, column access via \beachmat{} is even faster than access from simple matrices (Supplementary Figure~\suppfigsparsecol{}).
        ...
        We show that \beachmat{} provides faster row-level data access than the \textit{RcppArmadillo} API \cite{eddelbuettel2014arma}.
