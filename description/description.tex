...
We also demonstrate how \beachmat{} can be used by other Bioconductor packages to power the analysis of a very large scRNA-seq data set. 
...
We also thank Davis McCarthy for his assistance with incorporating \beachmat{} into \textit{scater}.
