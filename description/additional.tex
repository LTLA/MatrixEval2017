...
% Assuming R >=C, let S = RC^0.5 (derived by setting PQ = max(R, C) and assuming S = CP = RQ).
% P = S/C = R/C^0.5 and Q = S/R = C^0.5, thus satisfying 1 and 2.
% PQ = R >= C, thus satisfying 3 and 4.
