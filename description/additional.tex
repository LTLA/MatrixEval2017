...
It should be stressed that these timings were performed using consecutive row and column accesses.
The chunk cache ceases to be effective for a random access pattern, as there is no guarantee that the cached data will be contain the next requested row or column.
