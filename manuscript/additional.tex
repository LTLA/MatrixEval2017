...
Each \code{HDF5Matrix} instance provides methods to mimic a \code{matrix} object, allowing users to manipulate the matrix in real time without needing to load all of the data into memory.
