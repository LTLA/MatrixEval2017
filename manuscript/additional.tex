...
\begin{figure}[bt]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{}
    \end{subfigure}
    \caption{\revised{Timings for using \beachmat{} to access random} rows or columns \revised{of a simulated HDF5-backed matrix} constructed with different HDF5 file layouts, 
