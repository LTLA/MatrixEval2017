...
By default, \revised{dense} matrices were constructed using \revised{the \code{matrix} function}.
...
Conversion of each matrix object into other \revised{R} representations, if necessary, was performed prior to timing access with the C++ APIs.
