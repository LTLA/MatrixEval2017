...
We also recorded the time required to compute some gene- or cell-specific metrics (Figure~\ref{fig:zeisel}c, \suppsecrealzeisel{}) commonly used in scRNA-seq data analysis.
