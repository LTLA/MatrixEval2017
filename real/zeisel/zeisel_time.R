...
writeToFile(Type="ordinary", timings=dense.time, file="timings_col.txt", overwrite=TRUE)
...
writeToFile(Type="ordinary", timings=dense.time, file="timings_row.txt", overwrite=TRUE)
