...
library(HDF5Array)
#out.bycol <- writeHDF5Array(dense.counts, "bycol.h5", name="yyy", chunk_dim=c(ngenes, 1), level=6)
#out.byrow <- writeHDF5Array(dense.counts, "byrow.h5", name="yyy", chunk_dim=c(1, ncells), level=6)
#out.rect <- writeHDF5Array(dense.counts, "rect.h5", name="yyy", chunk_dim=c(100, 100), level=6)
